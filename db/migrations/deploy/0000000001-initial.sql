...
--
-- Name: relay_id(todo); Type: FUNCTION; Schema: data; Owner: superuser
--

CREATE FUNCTION relay_id(todo) RETURNS text
...
CREATE FUNCTION search_items(query text) RETURNS SETOF todos
    LANGUAGE sql STABLE
    AS $$
...
CREATE INDEX todo_relay_id_idx ON data.todo USING btree (relay_id(todo.*));
...
--
-- Name: todos.row_id; Type: ACL; Schema: api; Owner: api
--

GRANT SELECT(row_id) ON TABLE todos TO anonymous;
